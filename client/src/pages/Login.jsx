...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex bg-slate-900 text-slate-100 overflow-hidden">
      {/* Left SaaS Hero Branding Banner */}
      <motion.div
        initial={{ opacity: 0, x: -30 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.5 }}
        className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-sky-950 to-indigo-950 p-12 flex-col justify-between relative border-r border-slate-800"
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center space-x-3">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-sky-500 to-indigo-600 flex items-center justify-center text-white font-bold shadow-lg shadow-sky-500/30">
              <Sun className="w-7 h-7" />
            </div>
            <div>
              <h1 className="text-2xl font-black tracking-tight text-white">Dayflow</h1>
              <p className="text-xs text-sky-400 font-extrabold uppercase tracking-widest">
        ...
        <div className="relative z-10 space-y-6 my-auto max-w-lg">
          ...
          <div className="grid grid-cols-2 gap-4 pt-4">
            <motion.div
              whileHover={{ y: -3 }}
              className="p-4 rounded-2xl bg-slate-800/60 border border-slate-800 flex items-start space-x-3 backdrop-blur-md"
            >
        ...
        <div className="max-w-md w-full bg-white rounded-3xl shadow-xl border border-slate-200/80 p-8 md:p-10">
          ...
          {error && (
            <motion.div
              ...
              className="mb-6 p-4 rounded-2xl bg-rose-50 border border-rose-200 text-rose-700 text-sm flex items-center gap-2.5"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-2xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent text-sm bg-slate-50/50 font-medium"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-4 pr-11 py-3 rounded-2xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent text-sm bg-slate-50/50 font-medium"
                />
                <button
                  type="button"
          ...
          <div className="mt-8 pt-6 border-t border-slate-100">
            <p className="text-xs font-extrabold text-slate-400 uppercase tracking-wider mb-3 text-center">
              1-Click Hackathon Demo Persona Login
            </p>
